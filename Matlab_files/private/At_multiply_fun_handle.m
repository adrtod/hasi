function y=At_multiply_fun_handle(x,GXobs,Glr_mat_u,Glr_mat_v,GPmZ_old)
% this function multiplies A^T*x and returns
% this is required to be used becuse of the special structure of the matrix

%disp(size(GPmZ_old))
y= Glr_mat_u'*x ; clear Glr_mat_u; 
y=(Glr_mat_v*y); clear Glr_mat_v  % Low-rank*x
